...
This chapter surveys relevant literature across computer vision~\parencite{krizhevsky2012imagenet}, hate symbol
recognition~\parencite{belete2025200258,dasbhattacharjee2019365}, multimodal learning
~\parencite{dosovitskiy2020image}, few-shot classification~\parencite{radford2021clip}, and the broader ethical
challenges in AI system deployment~\parencite{ieee2021ethics}. Although direct research on image-based Nazi symbol
classification remains scarce, related work in extremist content moderation, iconographic recognition, and hate
speech detection provides valuable methodological context.

The review also addresses literature on dataset transparency, labeling practices, and the risks associated with
training AI on sensitive or harmful content. Together, these studies establish the technical and ethical foundations
of this thesis, and underscore key challenges such as limited annotated data, the need for robust visual features,
...
extremist media. Belete and Alitasb~\parencite{belete2025200258} developed a \ac{DL} pipeline for detecting
...
\ac{CLIP}, introduced by Radford et al.~\parencite{radford2021clip}, leverages contrastive
learning~\parencite{chen2020simpleframeworkcontrastivelearning} to align image and
